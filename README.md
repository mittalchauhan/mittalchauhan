# 🗂️ **Data Science Research & Strategic Portfolio**
...
| :--- | :--- | :--- | :--- | :--- |
| 1 | **Sentinel Gold** | **Multi-Modal Risk Fusion** | Spark, Kafka, GPT-2 | [View Repo](https://github.com/mittalchauhan/SENTINEL-GOLD-Multi-Modal-Cyber-Physical-Threat-Fusion-Engine) |
| 2 | **ELS-Pulse** | **Heuristic NLP & Brand Audit** | Ensemble ML, Streamlit | [View Repo](https://github.com/mittalchauhan/ELS-PULSE-SARCASM-AWARE-SENTIMENT-TERMINAL-AND-BRAND-CASE-STUDIES) |
| 3 | **InsuraPulse** | **Explainable AI (XAI)** | SHAP, Scikit-Learn | [View Repo](https://github.com/mittalchauhan/INSURA-PULSE-DYNAMIC-PREMIUM-REGRESSION-CASE-STUDY) |
| 4 | **QuantPro** | **Signal Processing** | yfinance, Pandas | [View Repo](https://github.com/mittalchauhan/QUANTPRO-REAL-TIME-STOCK-INTELLIGENCE-PIPELINE) |
| 5 | **MoviePulse** | **Latent Factor Modeling** | SVD, NLP, TF-IDF | [View Repo](https://github.com/mittalchauhan/MOVIE-PULSE-HYBRID-INTELLIGENCE-MATRIX) |
| 6 | **RetailPulse** | **Association Theory** | Apriori, FP-Growth | [View Repo](https://github.com/mittalchauhan/RETAIL-PULSE-PREDICTIVE-ASSOCIATION-STRATEGY-ENGINE) |
| 7 | **Consumer Audit** | **Consensus Methodology** | Flask, Scikit-Learn | [View Repo](https://github.com/mittalchauhan/CONSUMER-COMPLAINT-CLASSIFICATION-SYSTEM) |
| 8 | **LLM Foundations** | **Transformer Theory** | PyTorch, Tiktoken | [View Repo](https://github.com/mittalchauhan/LLM-Foundations-GPT-From-Scratch) |
| 9 | **Airline Fleet Planning**| **Strategic CAPEX Analysis** | Power BI, Power Query | [View Repo](https://github.com/mittalchauhan/-AIRLINE-FLEET-ANALYSIS-DASHBOARD) |
| 10 | **Shopping Trends** | **Behavioral Economics** | Power BI, DAX | [View Repo](https://github.com/mittalchauhan/-SHOPPING-TREND-ANALYTICS-DASHBOARD) |
...
* **Portfolio Note:** Each sub-directory includes a detailed README and development notebooks (`.ipynb`) documenting the full research methodology.
